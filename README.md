...
<p>
The next step we are going login to DC-1 and enable ICMPv4 on the windows firewall and see if we can ping CLinet-1 to DC-1 with ping -t meaning it won't pining until we stop it.
</p>
<br />
